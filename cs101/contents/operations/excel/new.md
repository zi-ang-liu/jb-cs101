...
<img src="./images/new/excel_input.png" alt="データの入力" width="600px">
...
「ホーム」タブの「フォント」グループの機能を使って、表の見た目を整えます。ここでは、太字と罫線を使います。太字は、フォントの「B」アイコンをクリックするか、<kbd>Ctrl</kbd> + <kbd>B</kbd>キーを押すことで設定できます。罫線は、フォントの「罫線」アイコンをクリックして、罫線の種類を選択します。
